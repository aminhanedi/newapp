        ...
        child: SingleChildScrollView(
          ...
          Row(
            children: [
              ...
              IconButton(
                onPressed: () async {
                  String number = "+93780700709"; // Update the phone number here
                  String uri = "tel:${number}"; // Remove the leading zero
