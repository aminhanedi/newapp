...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void fetchCustomers() {
    customersRef.onChildAdded.listen((event) {
      Map<dynamic, dynamic> item = Map<dynamic, dynamic>.from(event.snapshot.value as dynamic);
      setState(() {
        customerList.add(item);
      });
    });

    customersRef.onChildRemoved.listen((event) {
      Map<dynamic, dynamic> item = Map<dynamic, dynamic>.from(event.snapshot.value as dynamic);
      setState(() {
